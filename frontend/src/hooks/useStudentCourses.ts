...
import type { Course, CourseFolder, DeleteItemInput, MoveItemInput, RenameItemInput, SortOrder } from '../types/course'
...
export function useStudentCourses() {
  ...
  const addCourse = async (title: string): Promise<void> => {
